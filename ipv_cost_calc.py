...
with col1:
    st.image('/Users/michaelflorip/Desktop/Berkeley/dashing/assets/futureswithoutviolence-logo.png', width=300)
with col2:
    st.image('/Users/michaelflorip/Desktop/Berkeley/dashing/assets/dss logo copy.png', width=100)
